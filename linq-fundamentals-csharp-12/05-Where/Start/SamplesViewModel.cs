  ...
  public class SamplesViewModel : ViewModelBase
  {
    ...
    public List<Product> WhereQuery()
    {
      ...
      List<Product> list = new();
            ...
            list = (from prod in products
                    where prod.Name.StartsWith("S") || prod.ProductID>725
                    select prod).ToList();
    ...
    public List<Product> WhereMethod()
    {
      ...
      List<Product> list = new();
            ...
            list = products.Where(p => p.Name.StartsWith("S")||p.ProductID>725).ToList();
    ...
    public List<Product> WhereExtensionQuery()
    {
      ...
      List<Product> list = new();
            ...
            //list = products.Where(p=>p.Name.StartsWith("H")).ByColour("Red").ToList();
            list = (from prod in products select prod).ByColour("Red").ToList();
      // Write Query Syntax Here
